...
train_images, train_labels = get_images_and_labels('../data/dataset-4-words/train/', '../data/dataset-4-words/alt_train_labels.csv', number_output_layers)
val_images, val_labels = get_images_and_labels('../data/dataset-4-words/valid/', '../data/dataset-4-words/alt_val_labels.csv', number_output_layers)
